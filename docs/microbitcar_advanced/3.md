...
+ Build <img src="pic/3/3_13.png"> store <img src="pic/3/3_14.png">
+ Build <img src="pic/3/3_15.png"> Store the increased area and use the loop to increase the area of the color block gradually  
...
+ Create variables <img src="pic/3/3_17.png"> Record the moving direction of the car to determine the action of the car
+ Create variables <img src="pic/3/3_18.png"> Determine if the car has returned to red square
